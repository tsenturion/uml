...
%% Цель: показать корректное и аналитически оправданное применение каждого блока.
%% Внимание: блоки ограничивают область времени сверху вниз — всё внутри происходит
